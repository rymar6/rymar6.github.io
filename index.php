...
<table border="1"  align="center" width="100%"  background="images/bg-3.jpg" cellpadding="10" >
    ...
    <tr>
      <td colspan="2">
	  <font size="5"><b><a href="index.php">Головна</a>&nbsp;&nbsp; <a href="input.php">Зареєстровані</a>&nbsp;&nbsp; <a href="log.php">Інформація</a>&nbsp; &nbsp;<a href="foto.php">Фотогалерея</a>&nbsp; &nbsp;<a href="tel.php">Телефони</a></b></font></td>
    </tr>
    <tr>
